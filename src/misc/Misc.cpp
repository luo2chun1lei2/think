...
// property_name : 是两种情况，一种是用双引号来括起来文字，什么文字都可以。另外一种是"汉字\字母\数\_"组成的无空格字符串。
// 比如：  abc123  or "a b c 1 2 3" or abc_123
// property_value: 是两种情况，一种是用双引号括起来的文字，另外一种是表达式，可以是“汉字\字母\数\.\_”，目前不允许运算符号“+-*/%”等。
